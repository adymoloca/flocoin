...
(define* (make-flocoin-cross-toolchain target
                                       #:key
...
desirable for building Flocoin Core release binaries."
...
(define glibc-2.27/flocoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-flocoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/flocoin-patched
