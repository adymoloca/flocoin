...
**Flocoin Core's `configure` script by default will ignore the depends output.** In
...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_flocoin` executable (see https://github.com/flocoin/flocoin/pull/13543),
