...
First, in terms of structure, there is no particular concept of "Flocoin Core
...
Before you start contributing, familiarize yourself with the Flocoin Core build
system and tests. Refer to the documentation in the repository on how to build
Flocoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/flocoin/flocoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/flocoin/flocoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Flocoin Core PR Review Club](https://flocoincore.reviews/) meeting.
...
Most communication about Flocoin Core development happens on IRC, in the
`#flocoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#flocoin-core-dev). Chat
history logs can be found
on [http://www.erisian.com.au/flocoin-core-dev/](http://www.erisian.com.au/flocoin-core-dev/)
and [http://gnusha.org/flocoin-core-dev/](http://gnusha.org/flocoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/flocoin-dev)
...
For GUI-related issues or pull requests, the https://github.com/flocoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/flocoin/flocoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to flocoin-qt
...
fork of Flocoin Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/flocoin/flocoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Flocoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Flocoin
...
https://github.com/flocoin/flocoin/pull/16189).

Also see the [backport.py script](
https://github.com/flocoin-core/flocoin-maintainer-tools#backport).
