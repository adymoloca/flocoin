Flocoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/flocoin/files/Flocoin/flocoin-0.5.4/
...
http://gitorious.org/flocoin/flocoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Flocoin-Qt notifications under Growl 1.3.
Increase required age of Flocoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFlocoin properly when installing Flocoin-Qt over it. (Windows)
