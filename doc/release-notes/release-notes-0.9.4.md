Flocoin Core version 0.9.4 is now available from:

  https://flocoin.org/bin/0.9.4/
...
this update is incompatible with the Flocoin system and could lead to consensus
forks.

Flocoin Core released binaries from https://flocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~flocoin/+archive/ubuntu/flocoin
- A third-party or self-compiled Flocoin Core

upgrade to Flocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
