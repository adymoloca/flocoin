Flocoin Core version *0.15.2* is now available from:

  <https://flocoincore.org/bin/flocoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in flocoin-tx (TheBlueMatt)
