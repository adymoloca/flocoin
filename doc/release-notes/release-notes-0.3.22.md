Download URL: https://sourceforge.net/projects/flocoin/files/Flocoin/flocoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 FLO fee schedule (users still pay 0.01 FLO per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #flocoin00 - #flocoin99
