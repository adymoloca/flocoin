Flocoin Core version 0.13.2 is now available from:
  ...
  <https://flocoin.org/bin/flocoin-core-0.13.2/>
...
- #8908 `4a974b2` Update flocoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow flocoin-tx to create v2 transactions (flodrak)
