...
Flocoin Core version 0.19.1 is now available from:

  <https://flocoincore.org/bin/flocoin-core-0.19.1/>
...
From Flocoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Flocoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Flocoin Core does not yet change appearance when
...
- #17488 fix "flocoind already running" warnings on macOS (fanquake)
