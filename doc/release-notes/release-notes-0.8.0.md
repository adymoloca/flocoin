Flocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/flocoin/files/Flocoin/flocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Flocoin
...
New/changed settings (command-line or flocoin.conf file)
--------------------------------------------------------
