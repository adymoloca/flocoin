Flocoin Core version 0.16.1 is now available from:

  <https://flocoincore.org/bin/flocoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting flocoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure flocoind processes are cleaned up when tests end (sdaftuar)
