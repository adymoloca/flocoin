Flocoin Core version 0.9.2.1 is now available from:

  https://flocoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 FLO to 0.01 FLO
...
- Fix "Start flocoin on system login"
