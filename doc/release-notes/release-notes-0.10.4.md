Flocoin Core version 0.10.4 is now available from:

  <https://flocoin.org/bin/flocoin-core-0.10.4/>
...
- #6953 `43c2789` Split flocoin-tx into its own package
- #6953 `dfe0d4d` Include flocoin-tx binary on Debian/Ubuntu
