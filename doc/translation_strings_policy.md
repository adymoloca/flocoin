...
This document provides guidelines for internationalization of the Flocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `flocoin_en.ts` remains unchanged.
